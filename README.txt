...
Providing a search engine is a very complex subject if you aim to handle topics like relevance, semantics, performance and so on.
...
Feel free to give leave a [review here][6]. To get in touch with me you can [drop me an email][5].
...
* Define how long to store search results saving time for the same query
...
1. Adjust optional settings:
	...
	* Customize displayed text by editing the color with CSS
...
* It is not always easy to provide a lean navigation structure, especially when you have a deep content structure.
...
* BING is the most competitive one I've been able to find
